...
简单来说，VAE 是一种生成式 AI 模型。在自编码器的基础上，它通过学习潜在分布，从潜在空间中采样并生成新数据。

映射：
Data Distribution   ----> Latent Distribution
数据分布                 ----> 潜在分布
<img width="1923" height="827" alt="image" src="https://github.com/user-attachments/assets/a31f9e33-4b0c-4e81-8afd-510142df3331" />
...
<img width="966" height="568" alt="image" src="https://github.com/user-attachments/assets/f436195e-71a4-4df9-834e-b8820aa2cde6" />
<img width="2080" height="1245" alt="image" src="https://github.com/user-attachments/assets/0f67a1e0-127e-49ad-a4ae-d43a5a5d6018" />
# VAE代码示例！！！！
```python
import torch
